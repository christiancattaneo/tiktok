...
Description
Video Platform
Working social video platform that enables, at minimum, video upload, basic editing, playback, and social features (likes, comments, shares) with two types of users (creators and viewers)
AI Augmentation - Baseline
Platform automatically processes videos for optimization and provides basic AI-assisted editing features
AI Augmentation - Stretch
Enhanced AI experience with features like natural language editing, trend analysis, voice commands, or develop your own innovative AI features!
...
Description
 Feb 5, 2025
Video Platform MVP
Working platform with basic video record, upload, and playback
 Feb 7, 2025
TikTok Rebuild Complete
On Friday, you should submit your completed app.
 Feb 9, 2025
Week 1 Resubmission
On Sunday, you can resubmit to showcase progress.
 Feb 10, 2025
AI Objectives Start
...
On Friday you should have completed the AI features and submitted your final project.
